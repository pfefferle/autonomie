...
function zenpress_get_the_archive_description() {
	if ( is_home() ) {
		...
		$stats_text = sprintf( _n( 'Found %1$s search result for <strong>%2$s</strong>.', 'Found %1$s search results for <strong>%2$s</strong>.', $total, 'zenpress' ), number_format_i18n( $total ), get_search_query() );
