 ...
 * Slug: autonomie/post-audio
 * Categories: posts
 * Post Types: post
 * Description: Audio format - for audio content/podcasts
 */
?>

<!-- wp:group {"tagName":"article","className":"format-audio h-entry hentry"} -->
<article class="wp-block-group format-audio h-entry hentry">
