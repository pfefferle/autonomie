		...
		<main id="primary">
			...
			<article id="post-0" class="post error404 not-found">
				...
				<div class="entry-content e-entry-content">
					...
					<div class="widget">
						<h2 class="widgettitle"><?php _e( 'Most Used Categories', 'zenpress' ); ?></h2>
						<ul>
					...
					$archive_content = '<p>' . sprintf( __( 'Try looking in the monthly archives. %1$s', 'zenpress' ), convert_smilies( ':)' ) ) . '</p>';
